...
// Would nice for Oclif to export this type.
/**
...
exports.hook = async function (options) {
    if (options.plugin && options.plugin.type === 'npm') {
        ...
        try {
            ...
            await installationVerification_1.doInstallationCodeSigningVerification(configContext, { plugin: plugin.name, tag: plugin.tag }, vConfig);
        ...
        await installationVerification_1.doPrompt(VerificationConfigBuilder.buildForRepo());
    }
};
