...
class App extends Generator {
    ...
    install() {
        ...
        switch (this.type) {
            ...
            case 'plugin':
                ...
                break;
            case 'sfdx-plugin':
                dependencies.push('@oclif/command@^1', '@oclif/config@^1', '@oclif/errors@^1', '@salesforce/command@^2', '@salesforce/core@^2');
    ...
    _writeSfdxPlugin() {
        ...
        if (!fs.existsSync('src/commands')) {
            this.fs.copyTpl(this.templatePath(`src/sfdxCommand.${this._ext}.ejs`), this.destinationPath(`src/commands/${topic}/${sfdxExampleCommand}.${this._ext}`), Object.assign(Object.assign({}, opts), { pluginName: this.pjson.name, commandName: sfdxExampleCommand, topicName: topic }));
        }
        this.fs.copyTpl(this.templatePath('sfdxPlugin/src/index.ts'), this.destinationPath('src/index.ts'), opts);
        if (this.mocha && !fs.existsSync('test')) {
            this.fs.copyTpl(this.templatePath(`sfdxPlugin/test/command.test.${this._ext}.ejs`), this.destinationPath(`test/commands/${topic}/${sfdxExampleCommand}.test.${this._ext}`), Object.assign(Object.assign({}, opts), { name: sfdxExampleCommand, topic }));
        }
