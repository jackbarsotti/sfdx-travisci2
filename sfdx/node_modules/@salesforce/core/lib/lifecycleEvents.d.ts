...
declare type callback = (data: AnyJson) => Promise<void>;
/**
...
export declare class Lifecycle {
     ...
     */
    on<T extends AnyJson>(eventName: string, cb: (data: T | AnyJson) => Promise<void>): void;
    /**
     ...
     */
    emit(eventName: string, data: AnyJson): Promise<void>;
}
export {};
