 ...
 * @param value The value to test.
 */
export declare function asObject<T = object>(value: unknown): Optional<T>;
/**
 ...
 * @param defaultValue The default to return if `value` was undefined or of the incorrect type.
 */
export declare function asObject<T = object>(value: unknown, defaultValue: T): T;
/**
 * Narrows an `unknown` value to a plain `object` if it is type-compatible, or returns `undefined` otherwise.
 *
 * @param value The value to test.
 */
export declare function asPlainObject<T = object>(value: unknown): Optional<T>;
/**
 * Narrows an `unknown` value to an `object` if it is type-compatible, or returns the provided default otherwise.
 *
 * @param value The value to test.
 * @param defaultValue The default to return if `value` was undefined or of the incorrect type.
 */
export declare function asPlainObject<T = object>(value: unknown, defaultValue: T): T;
/**
 * Narrows an `unknown` value to a `Dictionary<T>` if it is type-compatible, or returns `undefined` otherwise.
 *
 * @param value The value to test.
 */
export declare function asDictionary<T = object>(value: unknown): Optional<Dictionary<T>>;
/**
 * Narrows an `unknown` value to an `object` if it is type-compatible, or returns the provided default otherwise.
 *
 * @param value The value to test.
 * @param defaultValue The default to return if `value` was undefined or of the incorrect type.
 */
export declare function asDictionary<T = object>(value: unknown, defaultValue: Dictionary<T>): Dictionary<T>;
/**
 ...
 * @param value The value to test.
 */
export declare function asArray<T = unknown>(value: unknown): Optional<T[]>;
/**
 * Narrows an `unknown` value to an `object` if it is type-compatible, or returns the provided default otherwise.
 *
 * @param value The value to test.
 * @param defaultValue The default to return if `value` was undefined or of the incorrect type.
 */
export declare function asArray<T = unknown>(value: unknown, defaultValue: T[]): T[];
/**
