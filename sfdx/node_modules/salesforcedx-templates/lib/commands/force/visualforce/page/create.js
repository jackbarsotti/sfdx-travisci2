...
const VF_TYPE = utils_1.MessageUtil.get('Page');
class VisualforcePage extends utils_1.TemplateCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            utils_1.CreateUtil.checkInputs(this.flags.pagename);
...
VisualforcePage.description = utils_1.MessageUtil.buildDescription('VFDescription', false, [VF_TYPE]);
...
VisualforcePage.help = utils_1.MessageUtil.buildHelpText(VisualforcePage.examples, false);
VisualforcePage.longDescription = utils_1.MessageUtil.get('VFLongDescription', [
    VF_TYPE,
    VF_TYPE
]);
VisualforcePage.flagsConfig = {
    ...
    pagename: command_1.flags.string({
        char: 'n',
        description: utils_1.MessageUtil.get('VFNameFlagDescription', [VF_TYPE]),
        longDescription: utils_1.MessageUtil.get('VFNameFlagLongDescription', [VF_TYPE]),
        required: true
    }),
    apiversion: command_1.flags.builtin(),
    label: command_1.flags.string({
        char: 'l',
        description: utils_1.MessageUtil.get('VFLabelFlagDescription', [VF_TYPE]),
        longDescription: utils_1.MessageUtil.get('VFLabelFlagLongDescription', [VF_TYPE]),
        required: true
    })
};
