...
export declare type MetadataTypesIndex = Map<string, MetadataType>;
/**
...
export declare class SourceLocations extends AsyncCreatable<SourceLocationsOptions> {
    ...
    private static _metadataTypesIndex;
    ...
    addMetadataType(pathMetadataType: MetadataType, sourcePath: string): void;
    ...
    static get metadataTypesIndex(): MetadataTypesIndex;
    static set metadataTypesIndex(newIndex: MetadataTypesIndex);
